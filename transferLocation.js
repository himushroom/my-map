    ...
    const promise = new Promise((resolve) => {
        ...
        function digui(num, r){
            ...
            if (!address) {
                ...
                geocoder
                .getPoint(address + shopName, (point) => {
                        console.log(address + shopName, point)
                        if (point) {
                            const tencentPoint = convertBaiduToTencent(point.lat, point.lng).toString()
                            console.log(tencentPoint)
                            sheet1[`P${num + 2}`].v = tencentPoint
                            digui(num+1, r)
                        } else{
